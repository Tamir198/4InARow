...
void startGame() {
	...
	while (true) {
		...
		if (isGameWon(lastCol, chooseFreeSquare(lastCol) - 1, player1)) {
		...
		if (isGameWon(lastCol, chooseFreeSquare(lastCol) - 1, player2)) {
